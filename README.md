...
1. Run `composer create-project --prefer-source --no-install --remove-vcs setono/sylius-cms-plugin:dev-master ProjectName` or just click the `Use this template` button at the right corner of this repository.
...
[ico-version]: https://poser.pugx.org/setono/sylius-cms-plugin/v/stable
[ico-unstable-version]: https://poser.pugx.org/setono/sylius-cms-plugin/v/unstable
[ico-license]: https://poser.pugx.org/setono/sylius-cms-plugin/license
...
[link-packagist]: https://packagist.org/packages/setono/sylius-cms-plugin
